...
{\huge Andrew J. Basinski \hspace{2.5in} August, 2019}
...
\begin{tabularx}{\textwidth}{p{\cellone} p{\celltwo}}
  \parbox[t][0cm]{\cellone}{P\textsc{ublications}} &  \parbox[t][0cm]{12cm}{ 
    ...
    \item {\bf Basinski AJ} et al. Evaluating the promise of recombinant transmissible vaccines. Vaccine (2017).
...
\begin{tabularx}{\textwidth}{p{\cellone} p{\celltwo}}
  \parbox[t][0cm]{\cellone}{P\textsc{ublications} In P\textsc{rogress}} &  \parbox[t][0cm]{12cm}{ 
    ...
    \item {\bf Basinski AJ}, Nuismer SL. Forecasting the risk of Lassa from rodent reservoirs across West Africa. In progress. 

      \vspace{0.05in}      
           
    \item Schreiner CL, {\bf Basinski AJ}, Nuismer SL. When to vaccinate a fluctuating wildlife population: is timing everything? Journal of Applied Ecology. Manuscript under review. 
